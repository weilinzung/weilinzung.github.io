...
//Custom JS animation
function js_animation(){
	$("#cw1").addClass("c-path c1"); 
	$("#cw2").addClass("c-path c2"); 
	$("#cw3").addClass("c-path c3");
	...
	if (device.mobile()) {
		...
		$('.desktop-elements').remove();

		$('.terminal-content-hold').remove();

		var termynal = new Termynal('.terminal-content', {
			noInit: true,
		});
		...
		// all other elements
		function js_timer(){
			terminalVar = setTimeout(function() {

				//Terminal Scripts
				$('.terminal-content-hold').fadeOut('slow');
				...
				$('.mobile-elements').remove();

				$('.loader-wrapper').delay(500).fadeIn('slow');

			 }, 1000);

			browserVar = setTimeout(function() {
				//Browser Scripts
				$('.loaded-bg').fadeIn('slow');

				$('.loader-wrapper').hide();

				$('.browser-content').fadeIn('slow');

				$('.browser-content .up').addClass('animated fadeInUp');
				$('.browser-content .right').addClass('animated fadeInRight');
	...
	$('.landing').imagesLoaded({ background: true }, function() {
		...
		$('.calligraphy-wrapper').delay(3800).queue(function(){
			$(this).addClass('animated slideOutUp');
		});

		setTimeout(function() {

			// $('.calligraphy-logo').fadeOut('slow');

			// $('.calligraphy-wrapper').slideUp('slow', function () {
			// 	$(this).remove();
			// });

			$('.calligraphy-wrapper').remove();

			if (device.mobile()) {

				$('.terminal').addClass('animated fadeIn');

				$('.broswer').delay(300).queue(function(){
				  $(this).addClass('animated fadeIn');
				});

				$('.moment').delay(1200).queue(function(){
				  $(this).addClass('animated fadeIn');
				});

			} else {
				$('.terminal').addClass('animated fadeInUp');
				...
				//run all other elements after preloader
				setTimeout(function() { 
					js_timer();
				}, 1000);
			}
...
// run JS animation on load
window.onload = function() {
  js_animation();
  // window.onresize = js_animation;
};
...
jQuery(function($){
  ...
  $('.dribbble').click(function(e) {
    ga('send', 'event', 'Outbound Link', 'Click', 'Dribbble');
  });
  ...
  $('.instagram').click(function(e) {
    ga('send', 'event', 'Outbound Link', 'Click', 'Instagram');
  });

  $('.resume').click(function(e) {
    ga('send', 'event', 'Outbound Link', 'Click', 'Resume');
  });

  $('.email').click(function(e) {
    ga('send', 'event', 'Outbound Link', 'Click', 'Email');
  });
